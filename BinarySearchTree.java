...
public class BinarySearchTree<E extends Comparable<E>> extends AbstractTree<E> {
    ...
    public ArrayList<E> leftSubTree(E e) {
        ...
        if (current != null) {
            preorderLeft(current.left, list);
    ...
    protected void preorderLeft(TreeNode<E> root, ArrayList<E> list) {
        if (root == null) {
            return;
        }
        list.add(root.element);
        preorderLeft(root.left, list);
        preorderLeft(root.right, list);
    }
    ...
    private boolean sameTree(TreeNode<E> tree1, TreeNode<E> tree2) {
        if (tree1 == null && tree2 == null) {
            return true;
        } else if (tree1 != null && tree2 != null) {
            return (tree1.element == tree2.element && sameTree(tree1.left, tree2.left) && sameTree(tree1.right, tree2.right));
        } else {
            return false;
        }
    }
    ...
    protected void inorderPredecessor(TreeNode<E> root, ArrayList<E> list) {
        inorderPredecessor(root.left, list);
        list.add(root.element);
        inorderPredecessor(root.right, list);
    }
